...
<%
    ...
    try{
        ...
        <div class="col-md-12">
    		...
    		<% 
    		String sql1 = "select * from (select bbs.sub_forum.main_id,bbs.post.content,bbs.sub_forum.id,bbs.post.user_id,bbs.post.post_title,bbs.post.send_time,bbs.post.view_num,bbs.post.reply_num,bbs.post.id as post_id,bbs.sub_forum.sub_forum_title,bbs.post.post_type from  bbs.post inner join  bbs.sub_forum on bbs.post.sub_id=bbs.sub_forum.id) as t left join bbs.user on bbs.user.id=user_id where main_id=? and post_type=3 order by reply_num desc";
