...
<%
 ...
 <a href="othersSend.jsp?pageid=1">首页</a>
 <a href="othersSend.jsp?pageid=<%=currentPage-1%>">上一页</a>
	<% 
  ...
  { 
    if(j==currentPage)
      out.print("[");
     %>
    <A href="othersSend.jsp?pageid=<%=j %>"><%=j %></a>
    <%
    if(j==currentPage)
      out.print("]");
    out.print("  ");
...
%> 
   <a href="othersSend.jsp?pageid=<%=currentPage+1%>">下一页</a>
 	<a href="othersSend.jsp?pageid=<%=totalPages%>">末页</a>
