        ...
        <div class="col-xs-3">
            <ul class="nav nav-pills nav-stacked">
                <li role="presentation" ><a href="othersInformation.jsp">Ta的信息</a></li>
                  ...
                  <li role="presentation" class="active"><a href="othersReply.jsp">Ta的回帖</a></li>
...
<BR>当前显示第<Font color=blue>
 ...
 <a href="othersReply.jsp?pageid=1">首页</a>
 <a href="othersReply.jsp?pageid=<%=currentPage-1%>">上一页</a>
	<% 
  ...
  { 
    if(j==currentPage)
      out.print("[");
     %>
    <A href="othersReply.jsp?pageid=<%=j %>"><%=j %></a>
    <%
    if(j==currentPage)
      out.print("]");
    out.print("  ");
...
%> 
   <a href="othersReply.jsp?pageid=<%=currentPage+1%>">下一页</a>
 	<a href="othersReply.jsp?pageid=<%=totalPages%>">末页</a>
